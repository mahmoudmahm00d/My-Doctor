...
{
    public class ManagerAuthenticationAttribute : AuthorizationFilterAttribute
    {
        ...
        public static bool CheckToken(string token)
        {
            ...
            {
                var managerToken = db.Tokens.FirstOrDefault(t => t.Token == token && t.ObjectType == "Manager" && DateTime.Now < t.ExpireDate);
